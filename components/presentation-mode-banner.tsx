...
export function PresentationModeBanner() {
  ...
  return (
    ...
    >
      ...
      This live walkthrough uses deterministic synthetic state entirely in the browser, so it does
      not require PostgreSQL or access to any external bank system. The repository keeps the
      separate database-backed implementation and tests for technical review.
    </aside>
  );
}
