...
const required = ['recruiter-demo/index.html','recruiter-demo/styles.css','recruiter-demo/app.js','recruiter-demo/state.mjs','tests/recruiter-demo/state.test.mjs','vercel.json'];
